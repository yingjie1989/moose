...
template <>
InputParameters
validParams<ContactTractionVarAction>()
{
...
ContactTractionVarAction::ContactTractionVarAction(const InputParameters & params) : Action(params)
{
}

void
ContactTractionVarAction::act()
{
